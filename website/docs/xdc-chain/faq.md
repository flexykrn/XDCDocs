...
sidebar_position: 10
description: Common questions about XDC Network — wallets, gas, deployment, tokens, nodes, bridging, and troubleshooting.
---

{/* Sourced from live site https://xdc-docs-site.onrender.com/xdcchain/faq (2026-07-18). Original mkdocs.yml nav target xdcchain/faq.md was missing on disk. */}
...
**Manual:** See Wallet Configuration.
...
Never share your private key or seed phrase. Anyone with access can steal your funds. Store offline in a secure location.
:::
...
2. **Hardhat** (JavaScript) — Best for teams
3. **Foundry** (Rust) — Fastest
...
See the Masternode Setup Guide. Options include:
