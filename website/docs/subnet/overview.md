...
title: XDC Subnet
sidebar_position: 1
description: "Design and architecture of XDC Subnet: a private chain anchored to the XDC mainnet via checkpoint contracts and relayers."
---
...
<div className="section-body">
    <a href="../components/subnet_chain/" className="grid-item">
        <div>Components</div>
        <p>Continue reading on individual components of the Subnet architecture</p>
    </a>
    <a href="../install_guide/launch_subnet/" className="grid-item">
