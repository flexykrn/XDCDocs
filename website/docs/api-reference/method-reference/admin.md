...
See [admin_nodeInfo_response.json](/files/method-reference/admin_nodeInfo_response.json)
...
See [admin_peers_response.json](/files/method-reference/admin_peers_response.json)
