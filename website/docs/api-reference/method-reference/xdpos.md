...
See [XDPoS_getLatestPoolStatus_response.json](/files/method-reference/XDPoS_getLatestPoolStatus_response.json)
...
See [XDPoS_getSigners_response.json](/files/method-reference/XDPoS_getSigners_response.json)
...
See [XDPoS_getSignersAtHash_response.json](/files/method-reference/XDPoS_getSignersAtHash_response.json)
...
See [XDPoS_getSnapshot_response.json](/files/method-reference/XDPoS_getSnapshot_response.json)
