...
<div className="section-body">
    ...
    <a href="./xdcchain/developers/rpc/" className="grid-item">
        ...
        <a href="https://xinfin.org/quick-tools-guide" className="grid-item">
    ...
    <a href="./subnet/overview" className="grid-item">
        <div>XDC Subnet</div>
